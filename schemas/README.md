...
- applies completion-result v2 semantic validation after structural validation succeeds, including validation-objective correlation and action/reset chronology
