...
Current source candidate: **1.0.0-rc.1** (prepared and permanently validated, not yet published). See the [RC readiness record](releases/rc-readiness/1.0.0-rc.1.md).
