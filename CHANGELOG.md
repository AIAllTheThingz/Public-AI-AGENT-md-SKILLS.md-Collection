...
- Added the breaking completion-report template package 0.3.0 and completion-result schema v2.0.0, which require current completion records to carry execution-discipline evidence; existing template and schema consumers must migrate while historical or pinned v1 records remain supported.
