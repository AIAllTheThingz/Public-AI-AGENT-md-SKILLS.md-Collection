...
Per-sequence delegation handoff for `Completion record migration`, Sequence 1: `delegated: false`; no delegation occurred and the example maintainer retained the work; retry and no-progress boundaries remained preserved.
