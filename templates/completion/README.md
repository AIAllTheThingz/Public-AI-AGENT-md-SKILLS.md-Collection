...
| `{{DELEGATION_HANDOFF}}` | Whether work was delegated and, when true, its meaningful value, failure evidence, blocker, retry count, and unresolved state. |
