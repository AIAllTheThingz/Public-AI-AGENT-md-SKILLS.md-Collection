...
| `{{FAILED_OR_INDETERMINATE_OUTCOMES}}` | Failed or indeterminate execution outcomes keyed by objective, with non-empty summaries and that objective's complete failure-bearing retry ledger. |
