...
- Executed validation results name their exact retry-ledger objective; authorized resets identify and chronologically follow the immediately prior unresolved sequence; and pre-terminal evidence ends before the terminal attempt begins. Structural and semantic validation are both required for completion-result v2.
