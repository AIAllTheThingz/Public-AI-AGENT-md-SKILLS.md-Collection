---
id: DISC-EX-UX-ADOPTION
title: User Experience Adoption Example
version: 0.1.0
status: baseline
---

# User Experience Adoption Example

This fictitious example demonstrates composition and does not represent actual research.

The **Northstar Community Library** drafts a proposed patron renewal journey linked to `REQ-FUNC-001`. Because no patrons participated, research and usability evidence remain `NotRun`; the draft journey is labelled `Proposed`, not observed.
