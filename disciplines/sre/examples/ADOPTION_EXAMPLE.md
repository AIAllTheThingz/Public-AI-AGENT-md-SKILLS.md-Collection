...
- a scaling applicability matrix that justifies simple single-instance choices, leaves unexecuted scaling validation as `NotRun`, and therefore does not report the overall scaling strategy `Verified`
